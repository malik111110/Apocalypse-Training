...
```json
{
  "scenario": "game-zone_recon_to_access_chain",
  "input_signals": [
  ...
  "tool_calls": [
    {"name": "game-zone_surface_mapper", "priority": "high"},
    {"name": "game-zone_credential_validator", "priority": "high"},
    {"name": "game-zone_privesc_path_checker", "priority": "medium"}
  ],
  "mitigation": {
    "immediate": [
