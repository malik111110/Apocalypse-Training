...
```json
{
  "scenario": "daily-bugle_recon_to_access_chain",
  "input_signals": [
  ...
  "tool_calls": [
    {"name": "daily-bugle_surface_mapper", "priority": "high"},
    {"name": "daily-bugle_credential_validator", "priority": "high"},
    {"name": "daily-bugle_privesc_path_checker", "priority": "medium"}
  ],
  "mitigation": {
    "immediate": [
