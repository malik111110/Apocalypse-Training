...
```json
{
  "scenario": "blue_recon_to_access_chain",
  "input_signals": [
  ...
  "tool_calls": [
    {"name": "blue_surface_mapper", "priority": "high"},
    {"name": "blue_credential_validator", "priority": "high"},
    {"name": "blue_privesc_path_checker", "priority": "medium"}
  ],
  "mitigation": {
    "immediate": [
