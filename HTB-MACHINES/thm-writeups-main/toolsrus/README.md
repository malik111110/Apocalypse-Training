...
```json
{
  "scenario": "toolsrus_recon_to_access_chain",
  "input_signals": [
  ...
  "tool_calls": [
    {"name": "toolsrus_surface_mapper", "priority": "high"},
    {"name": "toolsrus_credential_validator", "priority": "high"},
    {"name": "toolsrus_privesc_path_checker", "priority": "medium"}
  ],
  "mitigation": {
    "immediate": [
